...
extern struct inode *pmfs_new_inode(struct mnt_idmap *idmap, pmfs_transaction_t *trans,
...
extern int pmfs_notify_change(struct mnt_idmap *idmap, struct dentry *dentry, struct iattr *iattr);
